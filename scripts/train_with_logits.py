...
from fingerprint.loss.focal import FocalLoss
    ...
    for epoch in range(epoch_start, epochs):
        ...
        for d in dataloader:
            ...
            with autocast(enabled=cast_dtype is not None, dtype=cast_dtype, device_type='cuda'):
                ...
                loss_logit = loss_fn_with_logits(output_dict['logits'], output_dict['gt'])['loss']
                loss += loss_logit
                loss_dict['loss'] = loss
                loss_dict['loss-Logit'] = loss_logit
